...
<Helmet>
		...
		{/* SEO 최적화를 위한 메타 태그 */}
		<title>포항 학산 한신더휴 - 단지배치도</title>
		<meta
		  name="description"
		  content="포항 학산 한신더휴의 단지 배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다.
"
		/>
  		<meta name="keywords"
		...
		<link
		  rel="canonical"
		  href="https://www.ifors2020.kr/ComplexGuide/intro"
		/>

		{/* Open Graph - 소셜 미디어 공유 최적화 */}
		<meta
		  property="og:title"
		  content="포항 학산 한신더휴 - 단지배치도"
		/>
		<meta
...
"
		...
		<meta
		  property="og:url"
		  content="https://www.ifors2020.kr/ComplexGuide/intro"
		/>
		  ...
		  {`
										{
											...
											"@type": "WebPage",
											"name": "포항 학산 한신더휴 - 단지배치도",
											"description": "포항 학산 한신더휴의 단지 배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다.
",
